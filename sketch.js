...
mainRacerImg1.setCollider("rectangle",0,0,mainCyclist.width,mainCyclist.height);
  mainRacerImg1.debug = false;
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("Pressione Seta Para Cima Para Reiniciar o Jogo", 500,50);
